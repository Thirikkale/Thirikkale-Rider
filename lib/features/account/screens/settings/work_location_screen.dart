...
class _WorkLocationScreenState extends State<WorkLocationScreen> {
  ...
  Future<void> _saveWorkLocation(Map<String, dynamic> location) async {
    setState(() { _saving = true; });
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('work_location', location['description'] ?? location['formatted_address'] ?? '');
    setState(() { _saving = false; });
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Work location set successfully!')),
      );
  ...
  void _selectLocation(Map<String, dynamic> location) async {
    ...
    await _saveWorkLocation(location);
  }
  ...
  void _navigateToMapSelection() {
    final mapLocation = {
      'description': 'Selected Address from Map: 789 Business Blvd, Springfield, IL 62701',
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Search for your work address',
